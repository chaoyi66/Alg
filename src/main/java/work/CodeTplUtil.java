...
public class CodeTplUtil {
	...
	public static void main(String[] args) {
		...
		// 创建临时文件
		List<String> prefixs = Lists.newArrayList("activity","advTemplate","advertise", "band","budget","cusChannel","cusFeature","cusNum","cusVip","customer","deal","empStatus","env","frequency","gift","image","layout","manager","meeting","meetTemplate","mind","motive","motiveCat","organization","paper","power","price","result","saleTarget", "saleTargetSplit","satisfaction","setout", "stock","stockCat","stockProduct","tidy","trait");

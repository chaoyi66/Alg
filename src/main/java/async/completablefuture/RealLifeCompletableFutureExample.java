...
public class RealLifeCompletableFutureExample {
	...
	public static void main(String[] args) {
		...
		cars().thenCompose(cars -> {
			System.out.println(Thread.currentThread().getName() + " !!!! get rating");
			List<CompletionStage<Car>> updatedCars = cars.stream()
					.map(car -> rating(car.manufacturerId).thenApply(r -> {
						System.out.println(Thread.currentThread().getName() + " !!!! set rating");
						car.setRating(r);
						return car;
			...
			System.out.println(Thread.currentThread().getName() + " !!!! when complete");
